                    ...
                    if line_text.startswith('event: '):
                        ...
                        try:
                            ...
                            if event_type == 'navigation':
                                ...
                                print(f"🎯 Navigation事件: url_param={data.get('url_param')}, thread_id={data.get('thread_id')}")
                                print(f"   workspace_url={data.get('workspace_url')}")
                            
                            # 检查interrupt事件
                            elif event_type == 'interrupt':
                                interrupt_received = True
                                print(f"🔄 Interrupt事件: {data.get('message', 'No message')}")
...
async def main():
    ...
    print(f"  Frontend-Backend Integration: {'✅ PASS' if frontend_backend_ok else '❌ FAIL'}")
