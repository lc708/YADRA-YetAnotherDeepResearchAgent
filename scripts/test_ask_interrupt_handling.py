                ...
                if line:
                    ...
                    if line_str.startswith("event: "):
                        ...
                        try:
                            ...
                            print(
                                f"事件: {event_type} - {json.dumps(data, ensure_ascii=False, indent=2)}"
                            )
                            ...
                            if event_type == "navigation":
                                ...
                                print(
                                    f"✅ 获取到导航信息: url_param={url_param}, thread_id={thread_id}"
                                )
                ...
                if line:
                    ...
                    if line_str.startswith("event: "):
                        ...
                        try:
                            ...
                            event_count += 1
                            print(
                                f"反馈事件 {event_count}: {event_type} - {json.dumps(data, ensure_ascii=False, indent=2)}"
                            )
