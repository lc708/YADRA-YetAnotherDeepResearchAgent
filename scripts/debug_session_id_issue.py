                    ...
                    if line.startswith('event: '):
                        ...
                        try:
                            ...
                            if current_event_type == 'navigation':
                                ...
                                print(f"🔥 Navigation事件中的session_id: {event_data.get('session_id')}")
                                print(f"🔥 session_id类型: {type(event_data.get('session_id'))}")
                                
                            elif current_event_type == 'metadata':
                                metadata_event = event_data
                                print(f"🔥 Metadata事件内容: {json.dumps(event_data, indent=2)}")
