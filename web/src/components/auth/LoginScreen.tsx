    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <Card className="w-full max-w-md shadow-lg border border-gray-200 bg-white">
        <CardHeader className="space-y-4 text-center">
          ...
          <div>
            <CardTitle className="text-2xl font-bold text-gray-900">
              {mode === 'signin' ? '登录到 YADRA' : '注册 YADRA 账户'}
            </CardTitle>
        ...
        <CardContent className="space-y-6">
          ...
          <Button
            variant="outline"
            className="w-full h-12 relative border-gray-300 text-gray-700 hover:bg-gray-50"
          ...
          <form onSubmit={handleEmailAuth} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                id="password"
                type="password"
                placeholder={mode === 'signin' ? '输入密码' : '设置密码（最少6位）'}
            ...
            <Button type="submit" className="w-full h-12 bg-blue-500 hover:bg-blue-600 text-white font-medium" disabled={isLoading}>
              {isLoading ? (
