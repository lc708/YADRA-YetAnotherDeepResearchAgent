            ...
            <div className="flex-1">
              {isEditing ? (
                <input
                  ...
                  className="w-full p-1 text-sm font-medium bg-background border rounded"
                  autoFocus
                />
              ) : (
      ...
      <AnimatePresence>
        {isExpanded && (
          ...
          >
            {/* 计划步骤 */}
            <div className="p-4">
              <h4 className="font-medium text-sm mb-4">执行步骤</h4>
            ...
            {showMetadata && plan.metadata && (
              <div className="p-4 border-t bg-muted/10">
                <h4 className="font-medium text-sm mb-2">计划详情</h4>
                <div className="grid grid-cols-2 gap-4 text-xs">
                  {plan.metadata.sources && (
                    <div>
                      <span className="text-muted-foreground">数据源: </span>
                      <span className="font-medium">{plan.metadata.sources} 个</span>
                    </div>
                  )}
                  {plan.metadata.tools && (
                    <div>
                      <span className="text-muted-foreground">工具: </span>
                      <span className="font-medium">{plan.metadata.tools.join(", ")}</span>
                    </div>
                  )}
