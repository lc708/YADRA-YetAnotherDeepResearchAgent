...
def test_projectmanager_streaming_enough_context_routes_to_reporter(monkeypatch):
    """Streaming projectmanager path must honor has_enough_context like structured output."""
    plan_json = _valid_plan(has_enough_context=True).model_dump_json()
